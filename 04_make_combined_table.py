...
###df[['case_DENOVO_MAT', 'case_DENOVO_PAT', 'case_LARGE50_DEV', 'case_LARGE100_DEV', 'case_LARGE500_DEV']] = df[['DENOVO_MAT', 'DENOVO_PAT', 'LARGE50_DEV', 'LARGE100_DEV', 'LARGE500_DEV']].apply(get_case, axis=0)
####print(df)
###
...
#df[['case_ZS_SAMPLES', 'case_LARGE25_DEV_GB', 'case_LARGE50_DEV_GB', 'case_LARGE100_DEV_GB', 'case_LARGE500_DEV_GB']] = df[['ZS_SAMPLES', 'LARGE25_DEV_GB', 'LARGE50_DEV_GB', 'LARGE100_DEV_GB', 'LARGE500_DEV_GB']].apply(get_case_2, axis=0)
